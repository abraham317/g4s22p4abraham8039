...
public class FrmPrincipal extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        dpprincipal.setBackground(new java.awt.Color(0, 153, 0));
        ...
        jMenu1.setBorder(new javax.swing.border.SoftBevelBorder(0));
        ...
        ISuma.setBackground(new java.awt.Color(0, 102, 51));
        ISuma.setText("Suma");
        ...
        IResta.setBackground(new java.awt.Color(0, 102, 51));
        ...
        IMultiplicacion.setAccelerator(javax.swing.KeyStroke.getKeyStroke(java.awt.event.KeyEvent.VK_M, java.awt.event.InputEvent.ALT_DOWN_MASK | java.awt.event.InputEvent.CTRL_DOWN_MASK));
        IMultiplicacion.setBackground(new java.awt.Color(0, 102, 51));
        ...
        IDivicion.setAccelerator(javax.swing.KeyStroke.getKeyStroke(java.awt.event.KeyEvent.VK_D, java.awt.event.InputEvent.ALT_DOWN_MASK | java.awt.event.InputEvent.CTRL_DOWN_MASK));
        IDivicion.setBackground(new java.awt.Color(0, 102, 51));
        ...
        IRaizcuadrada.setAccelerator(javax.swing.KeyStroke.getKeyStroke(java.awt.event.KeyEvent.VK_C, java.awt.event.InputEvent.ALT_DOWN_MASK | java.awt.event.InputEvent.CTRL_DOWN_MASK));
        IRaizcuadrada.setBackground(new java.awt.Color(0, 102, 51));
        ...
        IAcerca.setBackground(new java.awt.Color(0, 102, 51));
        IAcerca.setBorder(new javax.swing.border.SoftBevelBorder(0));
        IAcerca.setText("Acerca de");
        IAcerca.setCursor(new java.awt.Cursor(java.awt.Cursor.HAND_CURSOR));

        IAcercade.setAccelerator(javax.swing.KeyStroke.getKeyStroke(java.awt.event.KeyEvent.VK_A, java.awt.event.InputEvent.ALT_DOWN_MASK | java.awt.event.InputEvent.CTRL_DOWN_MASK));
        IAcercade.setBackground(new java.awt.Color(0, 102, 51));
